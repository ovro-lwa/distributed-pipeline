...
pm = OfflinePathsManager(utc_times_txt_path='/home/yuping/utc_times.txt',
                         ...
                         working_dir='/lustre/yuping/0-100-hr-reduction/salf/msfiles',
                         gaintable_dir='/lustre/yuping/2019-10-100-hr-take-two/bandpass/2018-03-22',
                         flag_npy_paths='/home/yuping/100-hr-a-priori-flags/20200602-consolidated-flags/20191125-consolidated-flags.npy')
...
def subsequent_frame_subtraction(dir1, dir2, datetime_1, datetime_2, out_dir):
    ...
    try:
        ...
        im1 = orca.transform.imaging.make_dirty_image(sorted(glob.glob(f'{tree2}/??_{datetime_2}.ms')), temp_tree,
                                                      datetime_2)
        im2 = orca.transform.imaging.make_dirty_image(sorted(glob.glob(f'{tree1}/??_{datetime_1}.ms')), temp_tree,
                                                      datetime_1)
...
def prep_image_for_sidereal_subtraction(dir1, dir2, datetime_1, datetime_2, out_dir1, out_dir2):
    ...
    try:
        ...
        im2 = orca.transform.imaging.make_dirty_image(sorted(glob.glob(f'{tree2}/??_{datetime_2}.ms')), temp_tree,
                                                      datetime_2)
